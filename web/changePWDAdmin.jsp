...
<%
	...
	try {
		...
		ResultSet rs = st.executeQuery("SELECT username, password FROM administrator where password= '"+ OldPassword + "'");
		if (rs.next()) {			
		...
		if (pass.equals(OldPassword)) {
			st = con.createStatement();
			int i = st.executeUpdate("UPDATE administrator SET password='"+ Newpass + "'WHERE password='" + OldPassword + "'");
