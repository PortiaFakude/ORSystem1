        ...
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <marquee behaviour = "scroll" direction = "left" <h5><span class="glyphicon glyphicon-lock"></span>MARKS</h5></marquee>
           ...
           <%@page import="java.sql.DriverManager"%>
            ...
            <%
            try{ 
            connection1 = DriverManager.getConnection(ConnectionUrl+DbName, UserId, password1);
            statement1=connection1.createStatement();
            String sql ="SELECT marks.mark_ID, subject.subject_Name, marks.mark_Perc "
                    + "FROM marks "
                    + "INNER JOIN subject"
                    + "ON marks.mark_ID = subject.subject_ID";
            ...
            <tr>
            <td><%=resultSet1.getString("mark_ID") %></td>
            <td><%=resultSet1.getString("mark_Perc") %></td>
            <td><%=resultSet1.getString("subject_Name") %></td>
