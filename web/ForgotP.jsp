...
<%
	...
	try {
		...
		ResultSet rs = st.executeQuery("SELECT password FROM learner WHERE username='"+ username + "'");
		if (rs.next()) {			
			pass = rs.getString("password");
                        out.println("Password retrieved, your password is : "+ pass);
                        out.println("<a Password retrieved, your password is : + pass  href='LearnerLogin.jsp'>Log In</a>");
