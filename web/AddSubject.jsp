...
<div class ="main2">
    <form method="post" action="subjects.jsp" onsubmit="return checkForm(this);">
    <fieldset>
        <div class="form-group">
            <h1>ADD SUBJECT</h1>
            
            <input type="text" name="subject_Name" id="subject_Name" required="required"/>
         <input <a href=""class="btn btn-lg btn-primary btn-block"  value="Save" type="submit" onsubmit="">
       
        </div>
    </fieldset>
    </form>  
    <p><h1>School subjects</h1> <br>
 ...
 <div>
<img class = "imagesidebar" src = "images/subjects.jpg"/> 
<img class = "imagesidebar" src="images/subjects1.jpg"/>
<img class = "imagesidebar" src="images/subject2.jpg"/>
</div>
