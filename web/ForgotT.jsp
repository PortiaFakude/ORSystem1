...
<%
	...
	try {
		...
		ResultSet rs = st.executeQuery("SELECT password FROM tblteacher WHERE username='"+ username + "'");
		if (rs.next()) {			
			pass = rs.getString("password");
                        out.println("Password retrieved, your password is : "+ pass);
                        out.println("<a Password retrieved, your password is : + pass  href='TeacherLogin.jsp'>Log In</a>");
