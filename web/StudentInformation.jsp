            ...
            <table border="1" width="40%">
                ...
                <c:forEach var="row" items="${result.rows}">
                    <tr>
                        ...
                        <td><a href="update.jsp?learner_ID=<c:out value="${row.learner_ID}"/>">Update</a></td>
                        <td><a href="javascript:confirmGo('Sure to delete this record?','deletedb.jsp?learner_ID=<c:out value="${row.learner_ID}"/>')">Delete</a></td>
